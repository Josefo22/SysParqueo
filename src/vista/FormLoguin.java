...
public class FormLoguin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1_Ingresar.setBackground(new java.awt.Color(52, 73, 94));
        ...
        jLabel5.setText("+57 302 2891396");
    ...
    if (jTextField2_Usuario.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El campo Usuario está vacío");
        return;
    }
    
    if (jPasswordField1_Contraseña.getPassword().length == 0) {
    ...
    usuario.setContraseña(new String(jPasswordField1_Contraseña.getPassword()).trim());
    ...
    if (controlUsuario.login(usuario)) {
        ...
        System.out.println("Inicio de sesión con éxito para usuario: " + usuario.getUsuario());
        // Aquí puedes redirigir a la siguiente ventana o pantalla principal
